package com.duyin.bookshelf.todo.dao;
...
public class BookShelfBeanDao extends AbstractDao<BookShelfBean, String> {
    ...
    public static class Properties {
        ...
        public final static Property ShelfTitle = new Property(18, String.class, "shelfTitle", false, "SHELF_TITLE");
        public final static Property ShelfTitleId = new Property(19, Integer.class, "shelfTitleId", false, "SHELF_TITLE_ID");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BOOK_SHELF_BEAN\" (" + //
                ...
                "\"SHELF_TITLE\" TEXT," + // 18: shelfTitle
                "\"SHELF_TITLE_ID\" INTEGER);"); // 19: shelfTitleId
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, BookShelfBean entity) {
        ...
        String shelfTitle = entity.getShelfTitle();
        if (shelfTitle != null) {
            stmt.bindString(19, shelfTitle);
        }
 
        Integer shelfTitleId = entity.getShelfTitleId();
        if (shelfTitleId != null) {
            stmt.bindLong(20, shelfTitleId);
        }
    }
    ...
    public BookShelfBean readEntity(Cursor cursor, int offset) {
        BookShelfBean entity = new BookShelfBean( //
            ...
            cursor.isNull(offset + 18) ? null : cursor.getString(offset + 18), // shelfTitle
            cursor.isNull(offset + 19) ? null : cursor.getInt(offset + 19) // shelfTitleId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, BookShelfBean entity, int offset) {
        ...
        entity.setShelfTitle(cursor.isNull(offset + 18) ? null : cursor.getString(offset + 18));
        entity.setShelfTitleId(cursor.isNull(offset + 19) ? null : cursor.getInt(offset + 19));
     }
