...
import com.duyin.bookshelf.todo.presenter.contract.BookDetailContract;
...
import static com.duyin.bookshelf.todo.presenter.BookDetailPresenter.FROM_BOOKSHELF;
...
public class BookDetailActivity extends MBaseActivity<BookDetailContract.Presenter> implements BookDetailContract.View {
    ...
    private void upImageView(String path, String name, String author) {
        ...
        ImageLoader.INSTANCE.load(path)
