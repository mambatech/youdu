...
import static com.duyin.bookshelf.todo.constant.AppConstant.MAP_STRING;
...
public class BookShelfBean implements Cloneable, BaseBookBean {
    ...
    private String shelfTitle; //探索分类title
    private Integer shelfTitleId = -1; //探索分类title id
    ...
    @Generated(hash = 171543969)
    public BookShelfBean(String noteUrl, Integer durChapter, Integer durChapterPage, Long finalDate, Boolean hasUpdate,
            Integer newChapters, String tag, Integer serialNumber, Long finalRefreshData, Integer group, String durChapterName,
            String lastChapterName, Integer chapterListSize, String customCoverPath, Boolean allowUpdate, Boolean useReplaceRule,
            String variable, Boolean replaceEnable, String shelfTitle, Integer shelfTitleId) {
        ...
        this.shelfTitleId = shelfTitleId;
    }
    ...
    public Integer getShelfTitleId() {
        return shelfTitleId;
    }

    public void setShelfTitleId(Integer shelfTitleId) {
        this.shelfTitleId = shelfTitleId;
    }
