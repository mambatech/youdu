...
import com.duyin.bookshelf.todo.help.AppFrontBackHelper;
import com.duyin.bookshelf.todo.help.CrashHandler;
...
public class MApplication extends Application {
    ...
    public void onCreate() {
        ...
        // init umeng sdk
        UMConfigure.init(this, "5e5a44be570df39f6300001f", "umeng", UMConfigure.DEVICE_TYPE_PHONE, null);
        //统计SDK是否支持采集在子进程中打点的自定义事件，默认不支持
        //UMConfigure.setProcessEvent(true);//支持多进程打点
        MobclickAgent.setPageCollectionMode(MobclickAgent.PageMode.AUTO);

       // Log.i("william", getTestDeviceInfo(getApplicationContext()));
    ...
    public static String getTestDeviceInfo(Context context){
        ...
        String s = "{device_id:" + deviceInfo[0] + ",mac:" + deviceInfo[1] + "}";
        return s;
    }
    @Override
