package com.duyin.bookshelf.base.net;
...
import com.duyin.bookshelf.todo.help.EncodeConverter;
import com.duyin.bookshelf.todo.help.SSLSocketClient;
import com.duyin.bookshelf.todo.model.analyzeRule.AnalyzeUrl;
import com.duyin.bookshelf.todo.model.impl.IHttpGetApi;
import com.duyin.bookshelf.todo.model.impl.IHttpPostApi;
    ...
    synchronized public static OkHttpClient getClient() {
        if (httpClient == null) {
            ...
            if (BuildConfig.DEBUG){
                builder.addInterceptor(new LoggerInterceptor("Mx_Http",true));
            }
